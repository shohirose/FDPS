...
class MatrixSym3 {
 public:
  ...
  MatrixSym3(const T _xx, const T _yy, const T _zz, const T _xy, const T _xz,
             const T _yz)
  ...
  MatrixSym3 operator+(const MatrixSym3& rhs) const {
    return MatrixSym3(xx + rhs.xx, yy + rhs.yy, zz + rhs.zz, xy + rhs.xy,
                      xz + rhs.xz, yz + rhs.yz);
  }
  ...
  T getTrace() const { return (xx + yy + zz); }

  template <typename U>
  operator MatrixSym3<U>() const {
    return MatrixSym3<U>(static_cast<U>(xx), static_cast<U>(yy),
                         static_cast<U>(zz), static_cast<U>(xy),
                         static_cast<U>(xz), static_cast<U>(yz));
  }
